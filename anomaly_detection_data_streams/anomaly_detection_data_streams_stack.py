...
class AwsAnomalyDetectionDataStreamsStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        input_data_stream = kinesis.Stream(self, 'inputDataStream',
                                           stream_name='aws-anomaly-detection-input-data-stream')
        ...
        vpc = ec2.Vpc(self, "VPC",
                      ...
                      subnet_configuration=[
                          ec2.SubnetConfiguration(
                              name="private", subnet_type=ec2.SubnetType.PRIVATE),
                          ec2.SubnetConfiguration(
